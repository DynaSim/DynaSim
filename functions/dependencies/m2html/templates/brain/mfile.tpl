...
<div class="fragment" style="background-image:url({MASTERPATH}brain.png)"><pre class="comment">{DESCRIPTION}</pre></div>

<!-- crossreference -->
<h2><a name="_cross"></a>CROSS-REFERENCE INFORMATION <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}up.png"></a></h2>
<div class="fragment" style="background-image:url({MASTERPATH}brain.png)">
This function calls:
...
<div class="fragment" style="background-image:url({MASTERPATH}brain.png)"><pre>{SOURCECODE}</pre></div>
<!-- END source -->
