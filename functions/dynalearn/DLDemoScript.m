...
m = DynaLearn(s, 'models/dlPredictivePFCDemo'); % ~ 120min
m.dlSimulate(); % ~ 40sec
m.dlSave(); % < 1sec
...
clc;
m = DynaLearn(); % ~ 1sec
% m = m.dlLoad('models/dlPredictivePFC'); % ~ 10sec
% m = m.dlLoad('models/dlPredictivePFC2'); % ~ 10sec
m = m.dlLoad('models/dlPredictivePFC3'); % ~ 10sec
% m.dlSimulate(); % ~ 40sec
