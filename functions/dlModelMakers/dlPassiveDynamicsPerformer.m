function m = dlPassiveDynamicsPerformer(RemakeFlag, ResetOptimalError, ModelName, ModelParameters, model_size_id, performance_coefficient, tune_flag, epochs)
    ...
    targetParams1 = [{'RPenalty', 4:9, 10, 1.01, 8, 30, 40, 90}; {'Compare', [1, 2], 0, perf_c, 0, 0, 0, 0}; {'Compare', [1, 3], 0, perf_c, 0, 0, 0, 0}]; % A 
    targetParams2 = [{'RPenalty', 4:9, 10, 1.01, 8, 30, 40, 90}; {'Compare', [2, 1], 0, perf_c, 0, 0, 0, 0}; {'Compare', [2, 3], 0, perf_c, 0, 0, 0, 0}]; % B
    targetParams3 = [{'RPenalty', 4:9, 10, 1.01, 8, 30, 40, 90}; {'Compare', [3, 1], 0, perf_c, 0, 0, 0, 0}; {'Compare', [3, 2], 0, perf_c, 0, 0, 0, 0}]; % C
