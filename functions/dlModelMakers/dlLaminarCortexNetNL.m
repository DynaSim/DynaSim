function y = dlLaminarCortexNetNL(ModelParameters, populationName)
    ...
    populationName = char("x" + populationName);
...
%     KDeepEDeepVip = k1*rand(NeDeep, NVipDeep) + 0.7;
    ...
    tauGABA_Som = 151; % ms, decay time constant of inhibition for beta (around 16Hz)
    tauGABA_PvSup = 57;
    tauGABA_PvDeep = 91;
    tauGABA_Vip = 101;
    ...
    SupL.connections(1).direction = [SupL.populations(1).name, '->', SupL.populations(2).name];
    ...
    % I-cells-PV
    MidL.populations(2).name = ['MidIPV', populationName];
    MidL.populations(2).size = NPvMid;
    ...
    % I-cells-SOM
    MidL.populations(3).name = ['MidISOM', populationName];
    MidL.populations(3).size = NSomMid;
    ...
    % I-cells-VIP
    MidL.populations(4).name = ['MidIVIP', populationName];
    MidL.populations(4).size = NVipMid;
    ...
    MidL.connections(1).direction = [MidL.populations(1).name, '->', MidL.populations(2).name];
    MidL.connections(1).source = MidL.populations(1).name;
    MidL.connections(1).target = MidL.populations(2).name;
    ...
    MidL.connections(2).direction = [MidL.populations(1).name, '->', MidL.populations(3).name];
    MidL.connections(2).source = MidL.populations(1).name;
    MidL.connections(2).target = MidL.populations(3).name;
    ...
    MidL.connections(3).direction = [MidL.populations(1).name, '->', MidL.populations(2).name];
    ...
    MidL.connections(4).direction = [MidL.populations(1).name, '->', MidL.populations(3).name];
    ...
    MidL.connections(end+1).direction = [MidL.populations(2).name, '->', MidL.populations(1).name];
    ...
    MidL.connections(end+1).direction = [MidL.populations(2).name, '->', MidL.populations(3).name];
    MidL.connections(end).source = MidL.populations(2).name;
    ...
    MidL.connections(end+1).direction = [MidL.populations(3).name, '->', MidL.populations(2).name];
    MidL.connections(end).source = MidL.populations(3).name;
    ...
    MidL.connections(end+1).direction = [MidL.populations(2).name, '->', MidL.populations(4).name];
    MidL.connections(end).source = MidL.populations(2).name;
    ...
    % I-cells-PV
    DeepL.populations(2).name = ['DeepIPV', populationName];
    DeepL.populations(2).size = NPvDeep;
    ...
    % I-cells-SOM
    DeepL.populations(3).name = ['DeepISOM', populationName];
    DeepL.populations(3).size = NSomDeep;
    ...
    % I-cells-VIP
    DeepL.populations(4).name = ['DeepIVIP', populationName];
    DeepL.populations(4).size = NVipDeep;
    ...
    DeepL.connections(1).direction = [DeepL.populations(1).name, '->', DeepL.populations(2).name];
    DeepL.connections(1).source = DeepL.populations(1).name;
    DeepL.connections(1).target = DeepL.populations(2).name;
    ...
    DeepL.connections(2).direction = [DeepL.populations(1).name, '->', DeepL.populations(3).name];
    DeepL.connections(2).source = DeepL.populations(1).name;
    DeepL.connections(2).target = DeepL.populations(3).name;
    ...
    DeepL.connections(3).direction = [DeepL.populations(1).name, '->', DeepL.populations(2).name];
    ...
    DeepL.connections(4).direction = [DeepL.populations(1).name, '->', DeepL.populations(3).name];
    ...
    DeepL.connections(end+1).direction = [DeepL.populations(2).name, '->', DeepL.populations(1).name];
    ...
    DeepL.connections(end+1).direction = [DeepL.populations(2).name, '->', DeepL.populations(3).name];
    DeepL.connections(end).source = DeepL.populations(2).name;
    ...
    DeepL.connections(end+1).direction = [DeepL.populations(3).name, '->', DeepL.populations(2).name];
    DeepL.connections(end).source = DeepL.populations(3).name;
    ...
    DeepL.connections(end+1).direction = [DeepL.populations(2).name, '->', DeepL.populations(4).name];
    DeepL.connections(end).source = DeepL.populations(2).name;
    ...
    % midEdeepE
    c = length(s.connections)+1;
    s.connections(c).direction = [MidL.populations(1).name, '->', DeepL.populations(1).name];
    s.connections(c).source = MidL.populations(1).name;
    ...
    % deepEmidE
    c = length(s.connections)+1;
    s.connections(c).direction = [DeepL.populations(1).name, '->', MidL.populations(1).name];
    s.connections(c).source = DeepL.populations(1).name;
    s.connections(c).target = SupL.populations(1).name;
    s.connections(c).mechanism_list={'iAMPActx'};
