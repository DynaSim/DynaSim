...
% Calculates the Thévenin equivalent voltage and conductance for a
...
%           name (ETH and gTH will be appended for Thévenin reversal potential
%           and conductance).
% Outputs:
%   data: data structure containing summed data
% Example:
%   data2 = ThevEquiv(data,{'IB_NG_IBaIBdbiSYNseed_ISYN','IB_NG_iGABABAustin_IGABAB','IB_FS_IBaIBdbiSYNseed_ISYN'},'IB_V',[-95,-95,-95]);
%    
% 
% Algorithm:
% Ionic channel's conductance, j, will be estimated by g_j(t) = I_j(t) ./ (V(t) - E_j)
% Thévenin equivalent conductance and reversal will be estimated as follows
%        gTh(t) = \sum_j{g_j(t)}
