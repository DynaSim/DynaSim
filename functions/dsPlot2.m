...
if ischar(data)
    ...
    handles = dsPlot2(data_img,varargin{:});
    return;
end
...
% Used when running xp_dsPlot or xp_ds.plotFR2
...
if ~strcmpi(force_overlay,'none')
    ...
    if only_one_cell
        ...
        % 1 cell. For example, 
        % close all; d = data_mat_pops; dsPlot2(d,'plot_type','rastergram','do_mean',1);
    end
