function str = strrep2(str,oldstr,newstr,lpad,rpad)
%ds.strrep - replace full words by new character strings, WITHOUT ignoring matches that appear as sub-strings.
%
