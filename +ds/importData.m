...
% - achieve by calling function ds.selectData() at end of this function.

% See also: ds.simulateModel, ds.exportData, ds.checkData, ds.selectData
  ...
  switch lower(ext)
    ...
    case '.csv'
      ...
      if ~(isempty(options.time_limits) && isempty(options.variables))
        ...
        data=ds.selectData(data,varargin{:}); % todo: create ds.selectData()
      end
    otherwise
