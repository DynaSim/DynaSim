...
%% handles=ds.plotData(data,'option',value)
...
% 
% See also: ds.calcFR, ds.calcPower, ds.plotWaveforms, ds.checkData, ds.plotData, xPlt,
%           nDDict
...
if ischar(data)
    ...
    handles = ds.plotData2(data_img,varargin{:});
    return;
end
...
% Used when running xp_ds.plotData or xp_ds.plotFR2
...
if ~strcmpi(force_overlay,'none')
    ...
    if only_one_cell
        ...
        % 1 cell. For example, 
        % close all; d = data_mat_pops; ds.plotData2(d,'plot_type','rastergram','do_mean',1);
    end
...
%                 plot_options.do_colorbar = true;
        ...
        case {'power','rastergram','raster'}
            % Disable legend when using ds.plotData
            subplot_options.legend1 = [];
            
            % Setup call to xp_ds.plotData
            plot_options.args = {plot_options.args{:}, 'plot_type',plot_type};
            data_plothandle = @xp_ds.plotData;
        ...
        case {'heatmapFR','heatmap_sortedFR','meanFR','meanFRdens'}
            ...
            % Setup call to xp_ds.plotFR2
            plot_options.args = {plot_options.args{:}, 'plot_type',plot_type};
            data_plothandle = @xp_ds.plotFR2;
    end
end
