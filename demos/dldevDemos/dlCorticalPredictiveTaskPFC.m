...
%%% Create model parameters struct
    ...
    outputParams = [{'deepExPFC_V', 1:floor(ModelParametersPFC.NeDeep/3), [200 400] ...
        ...
        {'supIPVxPFC_V', 1:ModelParametersPFC.NPvSuperficial, [200 800], 'afr'}; ...
        {'midIPVxPFC_V', 1:ModelParametersPFC.NPvMid, [200 800], 'afr'}; ...
        {'deepIPVxPFC_V', 1:ModelParametersPFC.NPvDeep, [200 800], 'afr'}];
