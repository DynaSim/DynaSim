...
ModelParametersPFC.NiSuperficial = 14;
ModelParametersPFC.NeMid = 27;
ModelParametersPFC.NiMid = 4;
ModelParametersPFC.NeDeep = 74;
ModelParametersPFC.NiDeep = 4;
...
ModelParametersV4.NiSuperficial = 12;
ModelParametersV4.NeMid = 24;
ModelParametersV4.NiMid = 5;
ModelParametersV4.NeDeep = 64;
ModelParametersV4.NiDeep = 7;
...
dsCellPFC = dlLaminarCortexNet(ModelParametersPFC, 'PFC'); % Laminar PFC model with specific parameters
dsCellV4 = dlLaminarCortexNet(ModelParametersV4, 'V4'); % Laminar V4 model with specific parameters
