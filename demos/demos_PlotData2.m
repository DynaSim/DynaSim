...
PlotData2(data,'max_num_overlaid',5,'force_last','populations');

% However, these can be messy, so the groups can be shifted up or down
PlotData2(data,'max_num_overlaid',5,'force_last','populations','do_overlay_shift',true);
...
PlotData2(data,'population','E','variable','v|I_iGABAa_s','force_last','variables','do_overlay_shift',true,'overlay_shift_val',3,'do_zscore',true,'do_zoom',1);

% % Double stack overlays
% PlotData2(data,'population','E','variable','iNa_m|I_iGABAa_s','force_last','variables','do_overlay_shift',true);
