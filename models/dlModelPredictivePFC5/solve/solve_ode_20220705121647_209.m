...
% STATE_VARIABLES:
supE_V_last =  -rand(1, p.supE_Npop)*74;
...
supI_V_last =  -rand(1, p.supI_Npop)*74;
...
midE_V_last =  -rand(1, p.midE_Npop)*74;
...
midI_V_last =  -rand(1, p.midI_Npop)*74;
...
deepE_V_last =  -rand(1, p.deepE_Npop)*74;
...
deepI_V_last =  -rand(1, p.deepI_Npop)*74;
