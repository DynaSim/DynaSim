...
% STATE_VARIABLES:
supE_V_last =  -rand(1, p.supE_Npop)*27;
...
supI_V_last =  -rand(1, p.supI_Npop)*27;
...
midE_V_last =  -rand(1, p.midE_Npop)*27;
...
midI_V_last =  -rand(1, p.midI_Npop)*27;
...
deepE_V_last =  -rand(1, p.deepE_Npop)*27;
...
deepI_V_last =  -rand(1, p.deepI_Npop)*27;
...
IO_SA1_V_last =  -60 - rand(1, p.IO_SA1_Npop)*17;
...
IO_SB1_V_last =  -60 - rand(1, p.IO_SB1_Npop)*17;
...
IO_SC1_V_last =  -60 - rand(1, p.IO_SC1_Npop)*17;
...
IO_SA2_V_last =  -60 - rand(1, p.IO_SA2_Npop)*17;
...
IO_SB2_V_last =  -60 - rand(1, p.IO_SB2_Npop)*17;
...
IO_SC2_V_last =  -60 - rand(1, p.IO_SC2_Npop)*17;
...
IO_Cx1_V_last =  -60 - rand(1, p.IO_Cx1_Npop)*17;
...
IO_Cx2_V_last =  -60 - rand(1, p.IO_Cx2_Npop)*17;
...
for k=2:ntime
  ...
  IO_SA1_V_k1 = sin(2.5*(t - (p.IO_SA1_t1+p.IO_SA1_t2)*0.5))*(100*(exp(- (t - p.IO_SA1_t1).^2) - exp(- (t - p.IO_SA1_t2).^2)) + p.IO_SA1_noise*randn(1, p.IO_SA1_Npop))/p.IO_SA1_C;
  ...
  IO_SB1_V_k1 = sin(2.5*(t - (p.IO_SB1_t1+p.IO_SB1_t2)*0.5))*(100*(exp(- (t - p.IO_SB1_t1).^2) - exp(- (t - p.IO_SB1_t2).^2)) + p.IO_SB1_noise*randn(1, p.IO_SB1_Npop))/p.IO_SB1_C;
  ...
  IO_SC1_V_k1 = sin(2.5*(t - (p.IO_SC1_t1+p.IO_SC1_t2)*0.5))*(100*(exp(- (t - p.IO_SC1_t1).^2) - exp(- (t - p.IO_SC1_t2).^2)) + p.IO_SC1_noise*randn(1, p.IO_SC1_Npop))/p.IO_SC1_C;
  ...
  IO_SA2_V_k1 = sin(2.5*(t - (p.IO_SA2_t1+p.IO_SA2_t2)*0.5))*(100*(exp(- (t - p.IO_SA2_t1).^2) - exp(- (t - p.IO_SA2_t2).^2)) + p.IO_SA2_noise*randn(1, p.IO_SA2_Npop))/p.IO_SA2_C;
  ...
  IO_SB2_V_k1 = sin(2.5*(t - (p.IO_SB2_t1+p.IO_SB2_t2)*0.5))*(100*(exp(- (t - p.IO_SB2_t1).^2) - exp(- (t - p.IO_SB2_t2).^2)) + p.IO_SB2_noise*randn(1, p.IO_SB2_Npop))/p.IO_SB2_C;
  ...
  IO_SC2_V_k1 = sin(2.5*(t - (p.IO_SC2_t1+p.IO_SC2_t2)*0.5))*(100*(exp(- (t - p.IO_SC2_t1).^2) - exp(- (t - p.IO_SC2_t2).^2)) + p.IO_SC2_noise*randn(1, p.IO_SC2_Npop))/p.IO_SC2_C;
  ...
  IO_Cx1_V_k1 = sin(2.5*(t - (p.IO_Cx1_t1+p.IO_Cx1_t2)*0.5))*(100*(exp(- (t - p.IO_Cx1_t1).^2) - exp(- (t - p.IO_Cx1_t2).^2)) + p.IO_Cx1_noise*randn(1, p.IO_Cx1_Npop))/p.IO_Cx1_C;
  ...
  IO_Cx2_V_k1 = sin(2.5*(t - (p.IO_Cx2_t1+p.IO_Cx2_t2)*0.5))*(100*(exp(- (t - p.IO_Cx2_t1).^2) - exp(- (t - p.IO_Cx2_t2).^2)) + p.IO_Cx2_noise*randn(1, p.IO_Cx2_Npop))/p.IO_Cx2_C;
