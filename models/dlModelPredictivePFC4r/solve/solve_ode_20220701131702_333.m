...
for k=2:ntime
  ...
  IO_SA1_V_k1 = sin(0.5*(t - (p.IO_SA1_t1+p.IO_SA1_t2)*0.5))*(100*(exp(- (t - p.IO_SA1_t1).^2) - exp(- (t - p.IO_SA1_t2).^2)) + p.IO_SA1_noise*randn(1, p.IO_SA1_Npop))/p.IO_SA1_C;
  ...
  IO_SB1_V_k1 = sin(0.5*(t - (p.IO_SB1_t1+p.IO_SB1_t2)*0.5))*(100*(exp(- (t - p.IO_SB1_t1).^2) - exp(- (t - p.IO_SB1_t2).^2)) + p.IO_SB1_noise*randn(1, p.IO_SB1_Npop))/p.IO_SB1_C;
  ...
  IO_SC1_V_k1 = sin(0.5*(t - (p.IO_SC1_t1+p.IO_SC1_t2)*0.5))*(100*(exp(- (t - p.IO_SC1_t1).^2) - exp(- (t - p.IO_SC1_t2).^2)) + p.IO_SC1_noise*randn(1, p.IO_SC1_Npop))/p.IO_SC1_C;
  ...
  IO_SA2_V_k1 = sin(0.5*(t - (p.IO_SA2_t1+p.IO_SA2_t2)*0.5))*(100*(exp(- (t - p.IO_SA2_t1).^2) - exp(- (t - p.IO_SA2_t2).^2)) + p.IO_SA2_noise*randn(1, p.IO_SA2_Npop))/p.IO_SA2_C;
  ...
  IO_SB2_V_k1 = sin(0.5*(t - (p.IO_SB2_t1+p.IO_SB2_t2)*0.5))*(100*(exp(- (t - p.IO_SB2_t1).^2) - exp(- (t - p.IO_SB2_t2).^2)) + p.IO_SB2_noise*randn(1, p.IO_SB2_Npop))/p.IO_SB2_C;
  ...
  IO_SC2_V_k1 = sin(0.5*(t - (p.IO_SC2_t1+p.IO_SC2_t2)*0.5))*(100*(exp(- (t - p.IO_SC2_t1).^2) - exp(- (t - p.IO_SC2_t2).^2)) + p.IO_SC2_noise*randn(1, p.IO_SC2_Npop))/p.IO_SC2_C;
  ...
  IO_Cx1_V_k1 = sin(0.5*(t - (p.IO_Cx1_t1+p.IO_Cx1_t2)*0.5))*(100*(exp(- (t - p.IO_Cx1_t1).^2) - exp(- (t - p.IO_Cx1_t2).^2)) + p.IO_Cx1_noise*randn(1, p.IO_Cx1_Npop))/p.IO_Cx1_C;
  ...
  IO_Cx2_V_k1 = sin(0.5*(t - (p.IO_Cx2_t1+p.IO_Cx2_t2)*0.5))*(100*(exp(- (t - p.IO_Cx2_t1).^2) - exp(- (t - p.IO_Cx2_t2).^2)) + p.IO_Cx2_noise*randn(1, p.IO_Cx2_Npop))/p.IO_Cx2_C;
